#!/usr/bin/env bash
# Copyright 2021  Zaion lab (Author: Bofeng Huang, Abdel Heba)
...
# lexicon to convert
# lexicon=LEX/MONTREAL/FR.dict
lexicon=lexicon/lexicon_final_1703_u.txt
# g2p model
g2p_model=LEX/MONTREAL/g2p_models/model.fst

# train set
train_set=train_hm_hm
# test set
